    ...
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      <div className=' grid grid-cols-1 gap-4 mb-4'>
        <div>
          ...
          <label className='text-gray-500 cursor-pointer ml-2' htmlFor='storeData'>Same my email for next time and comment</label>
        </div>
      </div>

      { Error && <p className='test-xs text-red-500'>All fields are required</p>}
